 ...
 ?>
  <nav class="navbar navbar-default">
   ...
   <div class="navbar-header">
     <a class="navbar-brand" href="#"><img src="/opt/ldap_user_manager/gfx/SlovenskoIT_logo.svg" width="30" height="30" class="d-inline-block align-top" alt=""><?php print $SITE_NAME ?></a>
   </div>
